...
if (isset($_POST['flight_id']) && isset($_POST['flight_dept']) && isset($_POST['flight_dest']) && isset($_POST['flight_dept_time']) && isset($_POST['flight_fly_time']) && isset($_POST['flight_limit_cnt'])) {
    ...
    $flight = $db->UpdateFlight($flight_id, $flight_dept, $flight_dest, $flight_dept_time, $flight_fly_time, $flight_limit_cnt, $flight_value);
    if ($flight) {
