...
public class FlightRegister extends AppCompatActivity {

    private static final String TAG = "RegisterActivity";
    private static final String URL_FOR_REGISTRATION = "https://test.fieldmaus.site/flight_register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flight_register);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (text_dept.getText().toString().equals(""))
                    ...
                    registerFlight(getIntent().getExtras().getString("airline_id"), text_dept.getText().toString(), text_dest.getText().toString(),
                            text_dept_time.getText().toString(), text_fly_time.getText().toString(), text_limit_cnt.getText().toString(), text_value.getText().toString());
                }
            }
        });
    }

    private void registerFlight(final String airline_id, final String flight_dept, final String flight_dest, final String flight_dept_time,
    ...
    private void showTimePickerDialog(final EditText editText) {
        editText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(FlightRegister.this, onTimeSetListener, 0, 0, is24Hour);
