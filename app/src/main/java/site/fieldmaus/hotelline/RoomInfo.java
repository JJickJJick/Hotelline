...
public class RoomInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        roomname.setText(getIntent().getExtras().getString("room_name"));
        limitcnt.setText(getIntent().getExtras().getString("limit_cnt"));
        text_value.setText(getIntent().getExtras().getString("room_value"));
