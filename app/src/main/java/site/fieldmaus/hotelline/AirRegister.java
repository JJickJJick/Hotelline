...
public class AirRegister extends AppCompatActivity {
    private static final String TAG = "RegisterActivity";
    private static final String URL_FOR_REGISTRATION = "https://test.fieldmaus.site/airline_register.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_register);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (text_airline_name.getText().toString().equals(""))
                    ...
                    registerAirline(text_airline_name.getText().toString(), getIntent().getExtras().getString("member_id"), text_airline_code.getText().toString());
            }
        });
    }

    private void registerAirline(final String airline_name, final String airline_owner, final String airline_code) {
        // Tag used to cancel the request
        String cancel_req_tag = "register";

        progressDialog.setMessage("Adding airline ...");
        showDialog();
