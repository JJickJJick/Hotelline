...
public class HotelInfo extends AppCompatActivity {
    ...
    private static final String URL_FOR_REGISTRATION = "https://test.fieldmaus.site/hotel_update.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        local.setText(getIntent().getExtras().getString("hotel_local"));
        hotelname.setText(getIntent().getExtras().getString("hotel_name"));
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hotelname.getText().toString().equals(""))
                    ...
                    registerHotel(hotelname.getText().toString(), getIntent().getExtras().getString("hotel_id"), local.getText().toString());
            }
        });
    }

    private void registerHotel(final String hotel_name, final String hotel_id, final String hotel_local) {
